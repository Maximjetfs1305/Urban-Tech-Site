(function () {
  ...
  function initContactModalStyle() {
    ...
    style.textContent = [
      ...
      ".ut-contact-item__icon{flex:0 0 42px!important;width:42px!important;height:42px!important;display:flex!important;align-items:center!important;justify-content:center!important;color:#f4be1b!important;background:rgba(244,190,27,.10)!important;font-size:19px!important;line-height:1!important;}",
      ".ut-contact-item__icon i{width:100%!important;height:100%!important;display:flex!important;align-items:center!important;justify-content:center!important;color:inherit!important;font-size:19px!important;line-height:1!important;margin:0!important;padding:0!important;}",
      ".ut-contact-item__icon i::before{display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;height:100%!important;line-height:1!important;margin:0!important;padding:0!important;}",
  ...
  function initContactModalTemplate() {
    ...
    dialog.innerHTML = [
      ...
      contactItem(CONTACTS.whatsapp, "bi-whatsapp", "WhatsApp", "Написати у WhatsApp", true),
