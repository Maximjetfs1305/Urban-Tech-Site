...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (electroGrid) {
    ...
    electroGrid.innerHTML = [
      '<div class="service-step-card" data-step="01"><div class="service-step-card__meta">01 | Проєктування</div><div class="service-step-card__icon"><i class="bi bi-pencil-square"></i></div><h3>Проєктування та планування</h3><p>Продумуємо майбутню систему ще до монтажу: логіку розеток, освітлення, кабельних трас, електрощита, навантажень і резерву під майбутнє розширення.</p><div class="service-step-card__line"></div></div>',
