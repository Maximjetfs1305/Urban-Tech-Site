...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const servicesCopy = {
    electro: {
      ...
      text: 'Комплексний електромонтаж для квартир, будинків, офісів і комерційних об’єктів: від продуманої розводки кабелю до щита, автоматики, освітлення та підготовки під майбутні системи.',
      cards: [
    ...
    security: {
      ...
      cards: [
        ...
        ['Пожежна частина', 'Підключаємо пожежні сповіщувачі, перевіряємо шлейфи, живлення, індикацію та коректну реакцію системи на спрацювання.'],
    ...
    video: {
      ...
      cards: [
        ...
        ['Віддалений перегляд', 'Підключаємо мобільні застосунки, доступ для власника, базові права користувачів і перевіряємо роботу з різних пристроїв.'],
    ...
    access: {
      ...
      cards: [
        ...
        ['Комфорт експлуатації', 'Передаємо підписані лінії, зрозумілу схему, доступ до обслуговування та можливість безболісного розширення системи.']
      ]
    },
    smart: {
    ...
    network: {
      ...
      text: 'Створюємо стабільну мережеву інфраструктуру для інтернету, камер, СКУД, робочих місць, серверних шаф, Wi‑Fi покриття та домашніх систем.',
      cards: [
    ...
    service: {
      ...
      cards: [
        ...
        ['Відновлення доступу', 'Скидаємо паролі, налаштовуємо реєстратори, користувачів, програми, мобільний перегляд і віддалене підключення.'],
        ['Ревізія шаф', 'Наводимо порядок у кабелях, підписуємо лінії, міняємо блоки живлення, перевіряємо резерв і залишаємо систему зручною для сервісу.'],
